...
#Repetability analysis for unweighted UniFrac community composition

par(mfrow=c(3,1))
pcoa <- read.csv("pcoa.csv", row.names=NULL, quote="")

shapiro.test(pcoa$UW1.1)
shapiro.test(pcoa$UW2.1)
cor.test(x = pcoa$UW1.1, y = pcoa$UW2.1)
shapiro.test(pcoa$UW1.2)
shapiro.test(pcoa$UW2.2)
cor.test(x = pcoa$UW1.2, y = pcoa$UW2.2)
shapiro.test(pcoa$UW1.3)
shapiro.test(pcoa$UW2.3)
cor.test(x = pcoa$UW1.3, y = pcoa$UW2.3)

plot(pcoa$UW2.1~pcoa$UW1.1, xlab = "Sample 1", ylab = "Sample 2", pch = 20)
plot(pcoa$UW2.2~pcoa$UW1.2, xlab = "Sample 1", ylab = "Sample 2", pch = 20)
plot(pcoa$UW2.3~pcoa$UW1.3, xlab = "Sample 1", ylab = "Sample 2", pch = 20)
